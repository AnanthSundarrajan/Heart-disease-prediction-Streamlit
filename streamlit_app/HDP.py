...
best_rf_model = joblib.load('streamlit_app/best_rf_model.joblib')
scaler = joblib.load('streamlit_app/scaler.joblib')
X_train_columns = joblib.load('streamlit_app/X_train_columns.joblib')
